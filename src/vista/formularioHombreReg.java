 ...
 * @author KELLY
 */
public class formularioHombreReg extends javax.swing.JDialog {

    /**
     * Creates new form formularioHombreReg
     */
    private User user;
    private UserController userController;
    private boolean state=false;
    public formularioHombreReg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar : Hombre");

        jLabel2.setText("Qué cualidades tienes?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formularioHombreReg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formularioHombreReg dialog = new formularioHombreReg(new javax.swing.JFrame(), true);
